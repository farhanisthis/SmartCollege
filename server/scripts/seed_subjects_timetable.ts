...
async function seedSubjectsAndTimetable() {
  try {
    ...
    // Clear existing data
    console.log("Clearing existing subjects and timetable...");
    ...
    const insertedSlots = await TimetableSlot.insertMany(timetable);
    console.log(`Inserted ${insertedSlots.length} timetable slots`);

    console.log("\n✅ Seed completed successfully!");
    console.log(`\nSummary:`);
    console.log(`- Subjects: ${insertedSubjects.length}`);
    console.log(`- Timetable Slots: ${insertedSlots.length}`);
